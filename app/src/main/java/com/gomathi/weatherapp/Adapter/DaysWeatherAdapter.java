...
public class DaysWeatherAdapter extends ArrayAdapter<String> {
    ...
    public DaysWeatherAdapter(Context context, String[] wData, String[] tData, String[] dData, int[] img) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inf.inflate(R.layout.itemrowdays, null);
